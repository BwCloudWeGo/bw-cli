...
func TestAddServiceWritesCompleteServiceStructure(t *testing.T) {
	...
	require.FileExists(t, filepath.Join(root, "internal", "order_item", "service", "command.go"))
	require.FileExists(t, filepath.Join(root, "internal", "order_item", "service", "dto.go"))
	...
	commandFile := readString(t, filepath.Join(root, "internal", "order_item", "service", "command.go"))
	...
	dtoFile := readString(t, filepath.Join(root, "internal", "order_item", "service", "dto.go"))
	require.Contains(t, dtoFile, "type OrderItemDTO struct")
	require.Contains(t, dtoFile, "type ListOrderItemDTO struct")
	require.Contains(t, dtoFile, "func toDTO")
	...
	require.NotContains(t, serviceFile, "func toDTO")
